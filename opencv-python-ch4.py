...
# cv2.line(img,(0,0),(300,300),(0,255,0),3)  # (선긋기) img, starting points , ending points, define color, define technic
...
cv2.rectangle(img,(0,0),(250,350),(0,0,255),cv2.FILLED) # img, start, end, color, technic = 사각형 꽉채우기

cv2.circle(img,(400,50),30,(255,255,0),5)       # (원) img, center point, radius, color, technic
